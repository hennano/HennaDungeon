...
public class SociallyDeadEndingScene extends MenuScene {
    ...
    private List<String> endingMessage = new ArrayList<>(Arrays.asList(
            ...
            player + ":\nこのことが決定打となり前パーティは仲間を見捨てるやべーやつ認定され活動に支障をきたしているらしい。もう自分は関係ないが",
            player + ":\nギルドの紹介で新しいパーティを組んだ。このパーティでは割とうまくやっていけてる。",
            player + ":\n来週、因縁のダンジョンへ遠征することが決まった。同時期にダンジョンにいたギルド1のパーティがまだ帰ってきていないらしい。",
            player + ":\n今回の遠征はそのパーティの遺品を回収することが目的。前回の情報があるぶんうまく立ち回れると思う。",
            "ToDo:助けを求めている人を助ける"
    ));
